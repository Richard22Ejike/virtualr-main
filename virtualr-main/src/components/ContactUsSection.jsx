  ...
  return (
    ...
    <div className="flex flex-col items-center p-8 lg:p-16 bg-green-700">
      ...
      <div className="flex flex-col lg:flex-row gap-12 w-full max-w-5xl">
        {/* Contact Form */}
        <form className="flex flex-col bg-green-900 p-8 rounded-lg shadow-lg w-full lg:w-2/3">
          ...
          <button
            type="submit"
            className="bg-green-600 text-white py-3 rounded-lg hover:bg-green-400 transition duration-300"
          >
            Send Message
          </button>
        </form>
